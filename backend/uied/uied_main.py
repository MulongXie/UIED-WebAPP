...
def uied(input_path, output_root, params=None, is_ip=True, is_clf=True, is_ocr=True, is_merge=True):
    ...
    if is_ip:
        ...
        ip.compo_detection(input_path, output_root, uied_params=params, resize_by_height=resized_height, show=False,
    ...
    if is_merge:
        ...
        merge.incorporate(input_path, compo_path, ocr_path, output_root, resize_by_height=resized_height, show=True)
